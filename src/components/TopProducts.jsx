...
import { newProducts } from '../utils/product';
...
const TopProducts = () => {
  ...
  const displayedProducts = showAll ? newProducts : newProducts.slice(0, 3);
      ...
      <div className="flex flex-wrap w-3/4 m-auto">
        {displayedProducts.map((item) => (
          <div
            id="products"
            key={item.id}
            className="w-96 ml-4 mr-4 mt-2 flex-1 opacity-0 translate-x-10"
          >
            <a href="#" className="group relative block overflow-hidden sm:w-52 xl:w-96">
              ...
              <div className="relative border border-gray-100 bg-white p-6">
                ...
                <form className="mt-4">
                  <button className="block w-full rounded bg-red-600 p-4 text-sm font-medium transition hover:scale-105 text-white">
                    Add to Cart
                  </button>
                </form>
              </div>
