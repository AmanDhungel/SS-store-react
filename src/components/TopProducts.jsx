...
const TopProducts = () => {
  ...
  return (
   ...
   {newProducts.map((item)=> (
    <div id="products" key={item.id}  className="w-96 ml-4 mr-4 mt-2 flex-1 opacity-0 translate-x-10" >
 ...
 <span className="whitespace-nowrap bg-yellow-400 px-3 py-1.5 text-xs font-medium">Top Selling</span>
